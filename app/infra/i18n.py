...
STRINGS: Final[dict[str, dict[str, str]]] = {
    "zh-CN": {
        ...
        "downloader.filename.label": "文件名:",
        "downloader.filename.placeholder": "留空 = 用视频标题 (那个名字通常很长)",
    ...
    "en-US": {
        ...
        "downloader.filename.label": "File name:",
        "downloader.filename.placeholder": "Leave empty to use the video title (usually very long)",
